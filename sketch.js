...
text("HOT CHOCOLATE IS READY ☕",110,200)
...
function generateScore(db_value) {
  ...
  if (db_value === "Karak") {
    ...
    const allowedItems = ["stove", "teapot", "sugar",  "milk","choc_powder"];
    ...
    const itemsToPenalize = ["esp","frothedmilk", "water", "tea_leaves"];
